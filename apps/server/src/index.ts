...
import { createBacklogModifyRoutes } from './routes/backlog-modify/index.js';
...
app.use('/api/features', createFeaturesRoutes(featureLoader, autoModeService));
...
app.use('/api/backlog-modify', createBacklogModifyRoutes(events, settingsService));
